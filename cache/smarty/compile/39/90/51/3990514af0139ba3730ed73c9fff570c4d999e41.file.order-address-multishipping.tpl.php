<?php /* Smarty version Smarty-3.1.19, created on 2015-02-26 19:12:44
         compiled from "C:\wamp\www\base\themes\default-bootstrap\order-address-multishipping.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1268854ef621ccd4741-65239217%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3990514af0139ba3730ed73c9fff570c4d999e41' => 
    array (
      0 => 'C:\\wamp\\www\\base\\themes\\default-bootstrap\\order-address-multishipping.tpl',
      1 => 1424822022,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1268854ef621ccd4741-65239217',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54ef6220efd957_98257234',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54ef6220efd957_98257234')) {function content_54ef6220efd957_98257234($_smarty_tpl) {?>
...
<?php $_tmp5=ob_get_clean();?><?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['back']->value) {?><?php echo "&mod=";?><?php echo (string)$_smarty_tpl->tpl_vars['back']->value;?><?php }?><?php $_tmp6=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('address',true,null,"back=".((string)$_smarty_tpl->tpl_vars['back_order_page']->value)."?step=1".$_tmp5.$_tmp6), ENT_QUOTES, 'UTF-8', true);?>
...
<i class="icon-chevron-right right"></i></span></a>
	...
	<p class="address_add submit">
		<a href="<?php ob_start();?><?php echo urlencode('&multi-shipping=1');?>
<?php $_tmp7=ob_get_clean();?><?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['back']->value) {?><?php echo "&mod=";?><?php echo urlencode($_smarty_tpl->tpl_vars['back']->value);?>
<?php }?><?php $_tmp8=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('address',true,null,"back=".((string)$_smarty_tpl->tpl_vars['back_order_page']->value)."?step=1".$_tmp7.$_tmp8), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Add'),$_smarty_tpl);?>
" class="button button-small btn btn-default"><span><?php echo smartyTranslate(array('s'=>'Add a new address'),$_smarty_tpl);?>
<i class="icon-chevron-right right"></i></span></a>
	</p>
