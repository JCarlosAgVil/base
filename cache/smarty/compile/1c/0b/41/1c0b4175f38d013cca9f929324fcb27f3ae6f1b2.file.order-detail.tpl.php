<?php /* Smarty version Smarty-3.1.19, created on 2015-02-26 19:13:11
         compiled from "C:\wamp\www\base\themes\default-bootstrap\order-detail.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2652054ef623771f6c3-22772879%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1c0b4175f38d013cca9f929324fcb27f3ae6f1b2' => 
    array (
      0 => 'C:\\wamp\\www\\base\\themes\\default-bootstrap\\order-detail.tpl',
      1 => 1424822022,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2652054ef623771f6c3-22772879',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54ef6247c0a462_10424475',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54ef6247c0a462_10424475')) {function content_54ef6247c0a462_10424475($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include 'C:\\wamp\\www\\base\\tools\\smarty\\plugins\\modifier.replace.php';
if (!is_callable('smarty_function_counter')) include 'C:\\wamp\\www\\base\\tools\\smarty\\plugins\\function.counter.php';
if (!is_callable('smarty_modifier_regex_replace')) include 'C:\\wamp\\www\\base\\tools\\smarty\\plugins\\modifier.regex_replace.php';
?>
...
<?php $_tmp36=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('get-file',true,null,"key=".$_tmp35."-".$_tmp36."&id_order=".((string)$_smarty_tpl->tpl_vars['order']->value->id)."&secure_key=".((string)$_smarty_tpl->tpl_vars['order']->value->secure_key)), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Download this product'),$_smarty_tpl);?>
"> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['product_name'], ENT_QUOTES, 'UTF-8', true);?>
 	</a>
									<?php } else { ?>
									<a href="<?php ob_start();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['filename'], ENT_QUOTES, 'UTF-8', true);?>
<?php $_tmp37=ob_get_clean();?><?php ob_start();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['download_hash'], ENT_QUOTES, 'UTF-8', true);?>
<?php $_tmp38=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('get-file',true,null,"key=".$_tmp37."-".$_tmp38), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Download this product'),$_smarty_tpl);?>
"> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['product_name'], ENT_QUOTES, 'UTF-8', true);?>
 	</a>
									<?php }?>
